...
router.post('/tarefas', TarefasController.createValidation, TarefasController.create);
router.delete('/tarefas/:id', TarefasController.deleteById, TarefasController.deleteByIdValidation);
