...
import { UserGroupIcon, ServerIcon, CalendarIcon, ChartSquareBarIcon, CogIcon, MenuIcon } from '@heroicons/react/outline';
            ...
            <div className="relative">
                ...
                {isMenuOpen && (
                    <ul className="absolute top-full left-0 bg-white text-lg shadow-md border border-gray-200 rounded-md py-2 w-max z-50">
                        <li className="flex items-center space-x-2 py-1 px-4 cursor-pointer hover:bg-gray-100" onClick={handleMenuToggle}>
